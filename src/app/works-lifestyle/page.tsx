...
const galleryItems = [
  { type: "image", src: "/lifestyle/main.png", className: "mt-[8vh] w-[90%] aspect-[1744/2336]" },
  { type: "image", src: "/lifestyle/1.jpg", className: "w-[90%] aspect-[2331/2914]" },
  { type: "image", src: "/lifestyle/A7403986.jpg", className: "w-[94%] aspect-[4672/5840]" },
  { type: "image", src: "/lifestyle/A7404010.jpg", className: "w-[88%] aspect-[4672/5840]" },
  { type: "image", src: "/lifestyle/RAMADAN.jpg", className: "w-[92%] aspect-[1080/1350]" },
  { type: "image", src: "/lifestyle/VALENTINES.jpg", className: "mb-[32vh] w-[90%] aspect-[2880/3840]" },
] as const;
    ...
    <main className="relative h-screen overflow-hidden bg-[#E5E5E3] text-[#151515]">
      ...
      <section className="relative z-10 grid h-full grid-cols-[1fr_minmax(300px,33vw)_1fr] items-center gap-[7vw] px-[8vw]">
        <div className="flex justify-end">
          <h1 className="font-editorial max-w-[220px] text-right text-[clamp(25px,2.1vw,38px)] leading-[0.86] tracking-[0.1em]">
            LIFE
            <br />
            STYLE
          </h1>
        ...
        <div className="grid max-w-[360px] grid-cols-[1px_1fr] gap-14">
          ...
          <div className="font-neue self-center text-[11px] leading-[1.25] text-black/58">
            <p className="max-w-[300px]">
              I do professional lifestyle photography with AI utilization
              specializing in authentic storytelling, blending high-resolution
              cinematic and editorial aesthetics to capture dynamic, visually
              compelling narratives that elevate modern brands.
            </p>
