...
const galleryItems = [
  { type: "image", src: "/nautique/nautique-1.jpg", className: "w-[116%] aspect-[16/11]" },
  { type: "image", src: "/nautique/nautique-2.jpg", className: "w-[88%] aspect-[4/5]" },
  { type: "image", src: "/nautique/nautique-4.png", className: "w-[92%] aspect-[4/5]" },
  { type: "image", src: "/nautique/nautique-5.png", className: "w-[86%] aspect-[4/5]" },
  { type: "video", src: "/nautique/nautique-3.mp4", className: "w-[132%] aspect-video" },
] as const;
      ...
      <section className="relative z-10 grid h-full grid-cols-1 items-center px-[10vw] md:grid-cols-[1fr_minmax(300px,33vw)_1fr] md:gap-[7vw] md:px-[8vw]">
        <div className="absolute bottom-12 left-5 z-30 flex justify-start md:static md:flex md:justify-end">
          <div className="flex flex-col items-start md:items-end">
            <h1 className="font-editorial max-w-[230px] text-left text-[clamp(25px,2.1vw,38px)] md:text-right leading-[0.86] tracking-[0.12em]">
              SUPER AIR
              <br />
              NAUTIQUE G25
            </h1>
        ...
        <div className="hidden max-w-[360px] grid-cols-[1px_1fr] gap-14 md:grid">
          ...
          <div className="font-neue self-center text-[11px] leading-[1.25] text-black/58">
            <p className="max-w-[300px]">
              Nautique Boat Company is a premier American boat manufacturer
              distinguished by its legacy under Correct Craft and its production
              of an elite lineup of inboard towboats engineered specifically for
